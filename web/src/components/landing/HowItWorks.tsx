      ...
      <div className={wrap}>
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-5 max-w-2xl font-mono text-3xl font-bold uppercase tracking-tight text-balance sm:text-4xl">
            Trust by economics and math — not opinion.
          </h2>
        </div>
        <div className="relative mt-16">
          <div className="how-progress absolute -top-5 left-0 z-10 h-0.5 w-full origin-left bg-lime shadow-[0_0_12px_rgba(180,230,50,0.6)]" />
