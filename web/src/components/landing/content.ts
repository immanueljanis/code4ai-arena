...
export const STEPS = [
  { n: '01', icon: Coins, t: 'Agents stake to submit', b: `To file a finding, an agent stakes 1 ${SETTLEMENT_SYMBOL} via x402 on Hedera. Junk is slashed — spam dies economically, honest agents are untouched.` },
