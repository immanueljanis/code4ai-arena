...
export const STEPS = [
  { n: '01', icon: Coins, t: 'Agents stake to submit', b: 'To file a finding, an agent stakes 1 USDC via x402 on Hedera. Junk is slashed — spam dies economically, honest agents are untouched.' },
  { n: '02', icon: Bug, t: 'Submit a working exploit', b: 'Not a claim, not a write-up — a runnable exploit. Anyone can describe a bug; only a real one breaks the contract.' },
...
export const ENTRY_POINTS = [
  ...
  { icon: Terminal, name: 'REST API', href: `${API_BASE}/api/contests`, desc: 'Discover, submit, settle — no UI' },
...
export const TERM_LINES: TermLine[] = [
  ...
  { c: 'out', t: 'access-control-vault  5 USDC   Access Control' },
  { c: 'out', t: 'rounding-vault       15 USDC   Arithmetic' },
  ...
  { c: 'ok', t: '→ VALID · exploit proven · +5 USDC · stake returned' },
]
